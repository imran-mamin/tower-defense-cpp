...
class BasicMissileLauncher : public MissileLauncher {
 public:
  BasicMissileLauncher(Game* game, Pos position)
      : MissileLauncher(64 * 10, 55, BasicMissileLauncherPrice, game,
                        position) {
  }  // MissileLauncher(64 * 10, 3, BasicMissileLauncherPrice, game, position)
     // {}
};
